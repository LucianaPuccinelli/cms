                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?= $this->Form->postLink(__('Deletar'), ['controller' => 'Bookmarks', 'action' => 'delete', $bookmarks->id], ['confirm' => __('Você tem certeza que deseja deletar o bookmark {0}?', $bookmarks->id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
